...
export default function Admin() {
  ...
  return (
    <>
      <main className="flex flex-col items-center w-full py-24 relative max-md:mt-6">
        <div className="flex flex-col items-center space-y-6 w-full">
          <div className="flex items-center justify-around">
            ...
            <button
              onClick={abrirModal}
              className="flex gap-2 bg-blue-600 text-white font-semibold rounded-lg p-2 absolute right-2 top-32 max-md:right-1/2 max-md:translate-x-1/2"
            >
              <Adicionar />Adicionar
            </button>
          </div>
